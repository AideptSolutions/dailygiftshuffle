...
const HEROES = {
  ...
  'stocking-stuffers':                { q: 'christmas stockings fireplace small gifts holiday', alt: 'Christmas stockings filled with small wrapped gifts' },
  'white-elephant-gifts':             { q: 'funny wrapped gift party colorful bow present', alt: 'A wrapped gift exchange present with a playful bow' },
  'secret-santa-gifts':               { q: 'wrapped christmas gift name tag festive', alt: 'A neatly wrapped secret santa gift with a name tag' },
  'christmas-gifts-for-her':          { q: 'christmas gift woman elegant wrapping ribbon festive', alt: 'Christmas gifts for her wrapped in festive paper with ribbon' },
  'christmas-gifts-for-him':          { q: 'christmas gift man kraft paper wrapping festive', alt: 'Christmas gifts for him wrapped in kraft paper with festive trim' },
  'retirement-gifts':                 { q: 'relaxing retirement hammock beach chair vacation', alt: 'A relaxing retirement scene with a lounge chair and travel gear' },
  'gifts-for-people-who-have-everything': { q: 'unique special gift box elegant surprise', alt: 'An unusual, beautifully wrapped gift that stands out from the pile' },
  'housewarming-gifts':               { q: 'housewarming new home candle plant cozy gift', alt: 'A cozy housewarming gift with a candle, plant and throw blanket' },
  'gift-ideas-for-sister':            { q: 'cheerful gift bright ribbon present colorful', alt: 'A cheerful gift for a sister wrapped with a bright ribbon' },
  'gift-ideas-for-brother':           { q: 'gift kraft paper wrapped present simple', alt: 'A gift for a brother wrapped in kraft paper' },
  '40th-birthday-gifts':              { q: 'birthday celebration balloons confetti party 40', alt: '40th birthday gifts with celebration balloons and confetti' },
  '50th-birthday-gifts':              { q: 'birthday celebration gold balloons elegant party', alt: '50th birthday gifts with gold balloons and celebration decor' },
  'gifts-for-teenage-girls':          { q: 'teen girl bedroom cozy aesthetic accessories', alt: 'Trendy gifts for teenage girls with skincare and cozy accessories' },
  'gifts-for-teenage-boys':           { q: 'gaming setup teen desk headset rgb', alt: 'Gifts for teenage boys with gaming gear and tech accessories' },
