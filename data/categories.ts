...
export const CATEGORIES: CategoryConfig[] = [
  ...
  },
  {
    slug: 'travel-gifts',
    tag: 'travel',
    title: 'Travel Gifts for Adventurers',
    emoji: '✈️',
    subtitle: 'Gifts for travelers, adventurers, and frequent flyers',
    description: 'Packing essentials, travel accessories, and clever gear for every type of trip.',
    intro: 'Whether they\'re a digital nomad hopping continents or a weekend warrior escaping the city, a great travel gift makes every journey smoother. Our curated travel gift picks cover all the bases — from TSA-friendly organizers and ultra-compact power banks to memory-foam neck pillows and RFID-blocking passport holders. These are gifts that go everywhere and get used on every trip.',
    relatedSlugs: ['outdoors', 'tech-gadgets', 'luxury-premium'],
    faqs: [
      { q: 'What are the best travel gifts under $30?', a: 'Top travel gifts under $30 include packing cubes, a passport holder with RFID blocking, a travel-sized toiletry set, a universal adapter, and a noise-isolating ear-plug kit. All pack flat and are genuinely useful from day one.' },
      { q: 'What travel accessories do frequent flyers actually want?', a: 'Frequent flyers swear by compression packing cubes (life-changing for overpacking), a quality memory-foam neck pillow, a slim carry-on organizer, a fast-charging power bank, and a good travel adapter. These reduce friction on every trip.' },
      { q: 'What\'s a good travel gift for someone who has everything?', a: 'For the seasoned traveler, think premium: a Tumi luggage tag, a Cabeau Evolution S3 neck pillow, a Nomatic travel backpack, noise-canceling earbuds, or a personalized passport cover in full-grain leather.' },
      { q: 'Are travel gifts practical for occasional travelers?', a: 'Absolutely — occasional travelers often lack the right gear most. A solid set of packing cubes, a universal power adapter, and a sturdy tote bag transform chaotic packing into an organized, stress-free experience.' },
    ],
  },
  {
    slug: 'beauty-self-care',
    tag: 'beauty',
    title: 'Beauty & Self-Care Gifts',
    emoji: '💅',
    subtitle: 'Gifts for the self-care lover, beauty enthusiast, and wellness seeker',
    description: 'Skincare, hair care, spa tools, and beauty devices for every budget and routine.',
    intro: 'Self-care isn\'t a luxury — it\'s a necessity, and the best beauty gifts make daily rituals feel special. From brightening vitamin C serums and facial ice rollers to LED light therapy masks and rosemary hair serums, our beauty and self-care picks are trending, dermatologist-approved, and genuinely effective. Perfect for birthdays, holidays, or any day that calls for a little indulgence.',
    relatedSlugs: ['fitness-biohacking', 'luxury-premium', 'gift-ideas-for-her'],
    faqs: [
      { q: 'What are the best beauty gifts under $25?', a: 'Top beauty gifts under $25 include a vitamin C face serum, a jade facial roller, a rosemary hair growth serum, a dermaplaning tool, and a set of hydrogel eye patches. These are widely loved and genuinely effective.' },
      { q: 'What skincare gifts are most popular right now?', a: 'In 2026, trending skincare gifts include peptide moisturizers, niacinamide serums, LED face masks, facial ice rollers, and barrier repair creams. Retinol serums and skin-cycling bundles are also extremely giftable.' },
      { q: 'What\'s a good beauty gift for someone with sensitive skin?', a: 'For sensitive skin, choose fragrance-free formulas: a gentle barrier repair moisturizer, a mineral SPF 50 sunscreen, soothing aloe vera gel, a soft silicone cleansing brush, or hyaluronic acid serum are all safe bets.' },
      { q: 'Are beauty devices worth gifting?', a: 'Yes — beauty devices like LED light therapy masks, facial ice rollers, microcurrent tools, and at-home dermaplaning kits have excellent reviews and deliver spa-like results. They\'re premium-feeling gifts that get used daily.' },
    ],
  },
  {
    slug: 'ai-smart-home',
    tag: 'ai-smart-home',
    title: 'AI & Smart Home Gifts',
    emoji: '🤖',
    subtitle: 'Cutting-edge AI gadgets and smart home devices for tech lovers',
    description: 'Smart speakers, AI wearables, smart displays, and home automation gifts for every budget.',
    intro: 'The smart home revolution is in full swing, and AI-powered gadgets are now among the most-gifted items on the planet. From hands-free smart speakers and intuitive smart displays to AI health wearables and whole-home automation hubs, our AI and smart home gift picks bring genuine convenience, energy savings, and a touch of the future to any home. Perfect for the tech-forward friend who loves being an early adopter.',
    relatedSlugs: ['tech-gadgets', 'office-professional', 'finance-productivity'],
    faqs: [
      { q: 'What are the best smart home gifts under $50?', a: 'The best smart home gifts under $50 include an Echo Dot smart speaker, a smart plug 4-pack, a Govee LED light strip with app control, and smart LED bulbs. These are easy to set up and work with Alexa and Google Home.' },
      { q: 'What AI gifts are trending in 2026?', a: 'Top AI gifts in 2026 include the Amazon Echo Show smart display, Oura Ring Gen 3 sleep tracker, Ray-Ban Meta smart glasses, Google Nest Hub with AI routines, and AI-powered ambient lighting systems like Nanoleaf Shapes.' },
      { q: 'Are smart home gifts easy to set up?', a: 'Most modern smart home devices take under 5 minutes to set up via a companion app. Smart plugs, smart bulbs, and Echo Dots are especially beginner-friendly — they work out of the box with Alexa or Google Home.' },
      { q: 'What\'s a good smart home gift for someone just starting out?', a: 'The ideal starter smart home gift is an Echo Dot or Google Nest Mini paired with a 2-pack of smart bulbs. This gives them voice control, music streaming, and a taste of automation without overwhelming complexity.' },
    ],
  },
];
