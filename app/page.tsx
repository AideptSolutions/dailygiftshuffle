...
const giftGuides = [
  {
    ...
    alt: 'Gift ideas for dad, gadgets, grilling gear, and accessories',
    title: 'Gifts for Dad',
    desc: 'Practical, fun picks for every kind of dad.',
  },
  {
    ...
    <div className="min-h-screen flex flex-col">
      ...
      >
        ...
        <p className="text-sm text-gray-500 mb-4">
          <span className="font-bold text-[#6D28D9]">New:</span>{' '}
          <Link href="/gift-genie" className="font-semibold text-gray-700 underline underline-offset-2 hover:text-[#6D28D9]">
            the Gift Genie
          </Link>{' '}
